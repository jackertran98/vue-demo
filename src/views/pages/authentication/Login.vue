...
import axios1 from '@core/axios/axios.js'
    ...
    login() {
      ...
      this.$refs.loginForm.validate().then(success => {
        if (success) {
          ...
          // var config={
          //   methods:'post',
          //   url:'https://identity.kttv.gov.vn:9443/oauth2/token?scope=openid',
          //   headers: { 
          //   'Authorization': 'Basic UlpCQjRSSzV0YUd0UmdKMFhXY2gwZmVSb25JYTpIQm9lSEdmUllLWHlnRG5rQVhjVVVmZmJEVTBh', 
            ...
            .then(response => {
              ...
              this.$router.push("screen-check")
                .then(() => {
                  ...
                  //     icon: 'CoffeeIcon',
                  //     variant: 'success',
                  //     text: `You have successfully logged in as ${this.userData.role}. Now you can start to explore!`,
                  //   },
                  // })
                })
            })
